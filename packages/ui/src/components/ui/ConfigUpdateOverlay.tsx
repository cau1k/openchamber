...
export const ConfigUpdateOverlay: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-background/80 backdrop-blur-md">
      <div className="w-full max-w-sm rounded-none-none border border-border/40 bg-card/90 px-6 py-8 text-center shadow-none">
        <div className="flex flex-col items-center gap-4">
          <div className="flex h-14 w-14 items-center justify-center rounded-none-none border-2 border-primary/30 border-t-transparent text-primary">

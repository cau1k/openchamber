...
export const CommandAutocomplete = React.forwardRef<CommandAutocompleteHandle, CommandAutocompleteProps>(({
  ...
  return (
    <div
      ref={containerRef}
      className="absolute z-[100] min-w-0 w-full max-w-[450px] max-h-64 bg-background border border-border rounded-none-none shadow-none bottom-full mb-2 left-0 flex flex-col"
    >
          ...
          <div>
            {commands.map((command, index) => (
              <div
                ...
                className={cn(
                  "flex items-start gap-2 px-3 py-2 cursor-pointer rounded-none-none",
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    {command.agent && (
                      <span className="typography-meta text-muted-foreground bg-muted px-1.5 py-0.5 rounded-none">
                        {command.agent}
                      </span>
                    )}
                  </div>

...
export const DirectoryExplorerDialog: React.FC<DirectoryExplorerDialogProps> = ({
  ...
  const treeSection = (
    <div className="flex-1 min-h-0 rounded-none-none border border-border/40 bg-sidebar/70 p-1.5 sm:p-2 sm:flex-none">
      <DirectoryTree
        variant="inline"
  ...
  const showHiddenToggle = (
    <button
      ...
      className="flex items-center gap-2 px-2 py-1.5 rounded-none-none hover:bg-accent/40 transition-colors typography-meta text-muted-foreground"
    >
      {showHidden ? (
  ...
  const mobileContent = (
    <div className="flex flex-col gap-3 h-full">
      ...
      <div className="flex-1 min-h-0 rounded-none-none border border-border/40 bg-sidebar/70 p-1.5 overflow-hidden">
        <DirectoryTree
          variant="inline"
          currentPath={pendingPath ?? currentDirectory}
          onSelectPath={handleSelectPath}
